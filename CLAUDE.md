...
>   on A's review). **Scene_V2 holds 16 arenas** (earlier notes saying 8 are stale). Remaining:
>   pillars in `TagArena.prefab` (user), rebuild binary, `TagMApoca_obs_smoke` gate, Phase A → gate
>   → Phase B, figures + Theory §14 completion.
